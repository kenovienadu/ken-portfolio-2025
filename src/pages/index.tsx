...
export default function Home() {
  return (
    <section>
      <MobileSummary />
      <div className="flex flex-col gap-10 max-w-2xl leading-10">
        <p className="opacity-70">
          I&#39;m a fullstack engineer with a knack for turning ideas into real, scalable software. Over the last six years,
          ...
          especially with tools like React, Node.js, and NestJS, and I thrive in teams that care about clean architecture,
        ...
        <p className="opacity-70">
          ...
          farmers with Agromall, I’m drawn to products that create real-world impact. I’ve also had the chance to mentor
          upcoming developers and guide technical direction on education platforms like Learners Corner.
        </p>

        <p className="opacity-70">
          When I&#39;m not deep in code or diagrams, I enjoy sharing what I’ve learned through talks and mentoring sessions.
